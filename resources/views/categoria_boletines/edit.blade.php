...
@endpush
@section('content')
  <h1 class="mt-4 fs-3">Editar Categoría</h1>
  <ol class="breadcrumb mb-4">
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ route('boletines.index') }}">Boletines</a></li>
    <li class="breadcrumb-item"><a href="{{ route('categorias-boletines.index') }}">Categorías</a></li>
    <li class="breadcrumb-item active">Editar Categoría</li>
  </ol>

  <form action="{{ route('categorias-boletines.update', $category) }}" method="POST">
    @csrf
    @method('PUT')
